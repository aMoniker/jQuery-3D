...
DDD.prototype.transform = function(transform_func, args) {
  ...
  if (!css_matrix || css_matrix === 'none') {
    ...
    matrix = DDD.prototype.parseMatrix(css_matrix);
  ...
  var decomposed = DDD.prototype.decomposeMatrix(matrix);
...
// components is an array of string, in any combination of these values:
// translation, scale, skew, perspective, quaternion
//  e.g. decomposeMatrix(matrix, ['translation', 'skew'])
//  will only return those two components
// If components is not specified, all components are calculated and returned
DDD.prototype.decomposeMatrix = function(matrix, components) {
  ...
  // this will need to be replaced with optional branches along the way
  // translation, scale, skew, perspective, quaternion
  var ret = {
...
// expects two vectors of equal length and two scalar values
...
// This is a copy of Sylvester 0.1.3 used for matrix math.
